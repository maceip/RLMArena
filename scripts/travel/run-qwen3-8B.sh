...
# VaaS Verification API Configuration
# Set these environment variables to enable verification plugins
export VAAS_ENABLE_VERIFICATION=${VAAS_ENABLE_VERIFICATION:-1}
export VAAS_ENABLE_CODE_LINTER=${VAAS_ENABLE_CODE_LINTER:-1}
export VAAS_ENABLE_SAFETY_FILTER=${VAAS_ENABLE_SAFETY_FILTER:-1}
export VAAS_ENABLE_TOOL_VALIDATOR=${VAAS_ENABLE_TOOL_VALIDATOR:-1}
export VAAS_ENABLE_JSON_SCHEMA=${VAAS_ENABLE_JSON_SCHEMA:-0}
export VAAS_ENABLE_SELF_CORRECTION=${VAAS_ENABLE_SELF_CORRECTION:-1}
export VAAS_MAX_CORRECTION_ATTEMPTS=${VAAS_MAX_CORRECTION_ATTEMPTS:-2}
export VAAS_FLOOR_REWARD=${VAAS_FLOOR_REWARD:--1.0}

# External verification API endpoints (optional)
# export VAAS_SNYK_API_KEY=""
# export VAAS_GITHUB_TOKEN=""
# export VAAS_SAFETY_API_URL=""
# export VAAS_CUSTOM_VERIFIER_URL=""
